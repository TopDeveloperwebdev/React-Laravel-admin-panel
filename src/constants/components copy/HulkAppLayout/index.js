				...
				{this.state.loading === true ?
					<div id="loading-bg" className="hk-full-loader" >
						<div className="text-center">
							<Box mb={3}>
								{isDarkModeActive ?
									<img alt="site-logo" width="110" height="30" src={require(`assets/Images/base-light.png`)} />
									:
									<img alt="site-logo" width="110" height="30" src={require(`assets/Images/base.png`)} />
								}
							</Box>
							<CircularProgress />
						</div>
